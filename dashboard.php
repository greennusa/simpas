<?php
    ...
    // Menghitung total data ruangan
    $sql_count_rooms = "SELECT COUNT(*) as total FROM ruangan";
    $result_count_rooms = $conn->query($sql_count_rooms);
    $row_count_rooms = $result_count_rooms->fetch_assoc();
    $count_rooms = $row_count_rooms['total'];
...
<div class="row">
        ...
        <a href="admin.php?page=peminjaman-barang">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm font-weight-bold text-primary mb-1">Data Barang</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_items ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-folder-open fa-3x text-gray-300"></i>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm font-weight-bold text-success mb-1">
                                Data Ruangan</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_rooms ?>
                            </div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-folder-open fa-3x text-gray-300"></i>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <a href="admin.php?page=pengaduan">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm font-weight-bold text-warning mb-1">
                                Data Pengaduan</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_complaints ?>
                            </div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-folder-open fa-3x text-gray-300"></i>
...
<div class="row">
    <div class="col-lg-6">
        <div class="card shadow mb-4">
            <div class="card-body" style="background: #CDE9F4;">
                <div class="card-header" style="background: #CDE9F4; color: #000;">
                    <h6 class="m-0 font-weight-bold text-primary">1. Alur Peminjaman Barang dan Peminjaman Ruangan</h6>
                </div>
    ...
    <div class="col-lg-6">
        <div class="card shadow mb-4">
            <div class="card-body" style="background: #CDE9F4;">
                <div class="card-header" style="background: #CDE9F4; color: #000;">
                    <h6 class="m-0 font-weight-bold text-primary">2. Alur Pengaduan Pelayanan</h6>
                </div>
                <div class="progress-container">
                    <ul class="progress-steps">
                        <li>Mengisi Form Pengaduan</li>
                        <li>Approve</li>
                        <li>On Progress</li>
                        <li>Return</li>
                    </ul>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-body" style="background: #FACDCD;">
            <h6 class="m-0 font-weight-bold text-primary" style="color: #000!important">Informasi Pengembalian Peminjaman :</h6>
                <p class="mt-2" style="color: #000!important">Untuk pengembalian peminjaman Barang dan Ruangan harap melaporkan kepada staff secara tata muka hingga masuk ke tahap returned</p>
            </div>
        </div>
    </div>
</div>

<?php
    ...
    $sql_count_available_items = "SELECT (b.total - COALESCE(p.jumlah_barang, 0)) as total_available
    FROM barang b
    LEFT JOIN (
    ...
    $count_available_items = $row_count_available_items['total_available'];
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-sm font-weight-bold text-success mb-1">
                            Barang Tersedia</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_available_items ?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-folder-open fa-3x text-gray-300"></i>
                    </div>
...
<script>
    ...
    var labels = Array.from({length: 31}, (_, i) => `${monthName} ${i + 1}`);  // Label untuk setiap hari dalam sebulan, ditambahkan prefix nama bulan

...
while ($row = mysqli_fetch_assoc($sql)) {
    ...
    $rowData = [
        ...
        $row['jumlah_barang'] . ' ' . $row['nama_satuan'],
        $row['tujuan'],
...
$objWriter->save('Data Peminjaman Barang.docx');
// download file
header("Content-Disposition: attachment; filename=Data Peminjaman Barang.docx");
readfile("Data Peminjaman Barang.docx");
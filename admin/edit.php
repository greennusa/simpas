...
<?php
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE user SET nama='$nama', email='$email', username='$username', password='$password' WHERE id_user='$id_user'";

        if ($conn->query($sql) === TRUE) {
            echo "<script>window.location.href='admin.php?page=admin&edit=true';</script>";
        } else {
